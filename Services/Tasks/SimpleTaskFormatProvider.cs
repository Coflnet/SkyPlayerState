...
/// <summary>
/// Default format provider, produces the short human readable formats the mod displays
/// (5.2M, 3.4h). Used both by tests and by production task execution (see TaskExecutionService).
/// </summary>
